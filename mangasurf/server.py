...
same ``mangasurf.gui.Api`` object the desktop app uses. So:
...
logger = logging.getLogger("mangasurf.server")
...
def serve(host="0.0.0.0", port=None, token=None, no_auth=False,
    ...
    """
    from mangasurf.servercfg import load_server_settings
...
def main(argv=None):
    ...
    if args.gui:
        from mangasurf.serverui import run_server_window
