"""Kamiya Scans (kamiyada.com / kamiyamanga.com) source scraper for Mangasurf.

High-speed scraper for manga and manhwa translations.
"""
...
SITE = "https://kamiyada.com"


class KamiyaSource(Source):
    id = "kamiya"
    name = "Kamiya Scans"
    base_url = SITE
    domains = (
        "kamiyada.com", "www.kamiyada.com",
        "kamiyamanga.com", "www.kamiyamanga.com",
        "kamiya.site", "www.kamiya.site",
        "kamiyascans.com", "www.kamiyascans.com",
    )
    ...
    search_sorts = ("Relevance", "Latest", "Popular")
    browse_sorts = ("Trending", "Latest", "Popular")
    ...
    def get_manga_info(self, manga_url: str) -> dict:
        ...
        if resp.status_code != 200:
            raise ScrapeError(f"Kamiya manga failed: HTTP {resp.status_code}")
        ...
        return {
            ...
            "tags": genres[:25],
            "status": status,
            "authors": authors or ["Kamiya Scans"],
            "artists": [],
            "series_type": stype,
            "source": self.id,
